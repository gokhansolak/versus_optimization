...
while not terminate:
    ...
    # if PROB succeeds, then choose any random neighbor
    if random.random() < PROB:
        # make random step
        n_random = random.choice(neighbors)
        current_solution = n_random['solution']
        current_evaluation = n_random['evaluation']

    else:
        # choose the improving neighbor
